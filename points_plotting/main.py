...
extract_data_make_plots(patient_id, patient_timepoint, nifti_file_path, slice_selected, scatter=False)
...
extract_data_make_plots(patient_id, patient_timepoint, nifti_file_path, slice_selected, scatter=True)
